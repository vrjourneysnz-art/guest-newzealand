...
export const itin12DaysNewZealandSouthIslandItinerary: RichItinerary = {
  ...
  metaDescription:
    "This 12 days New Zealand South Island Itinerary will bring you the key highlights closer. Do a fjord cruise, view penguins or walk through lush rainforest.",
  intro:
    "This 12 days New Zealand South Island Itinerary will bring you the key highlights closer. Do a fjord cruise, view penguins or walk through lush rainforest.",
  highlights: [
  ...
  days: [
    {
      ...
      description: "After arriving at Christchurch Airport, go to the rental car counter to collect your reserved car. The central city is only a short 15 minute drive away, so depending on your flight arrival time, you'll have some time to explore some of Christchurch.",
      accommodation: {
    ...
    },
    {
      ...
      activities: [
        ...
        {
          name: "Real Journeys Milford Sound Sc",
          type: "Included",
          description: "Real Journeys Milford Sound Sc — see operator site for full details.",
    ...
    },
    {
      ...
      title: "Queenstown",
      location: "Queenstown",
      description: "Queenstown is one of New Zealand's top visitor destinations. You'll be spellbound by the crystal clear Lake Wakatipu and it's dramatic alpine surrounds. Queenstown is also home to the ultimate adventure bucket list. Skiers love the winter months and all visitors love activities like bungy jumping, sky diving, canyon swinging, jet boating, horse trekking and river rafting. Queenstown is now a famous cycling destination with different graded scenic tracks.",
      accommodation: {
        name: "Chalet Queenstown Included",
      ...
      activities: [
        {
          name: "Lake M",
          type: "Recommended",
          description: "Lake M — see operator site for full details.",
        }
      ],
    },
    {

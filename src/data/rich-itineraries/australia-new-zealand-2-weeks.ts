...
export const australiaNewZealand2Weeks: RichItinerary = {
  ...
  metaDescription:
    "This Australia and New Zealand in 2 weeks holiday offers tours from snorkel Great Barrier Reef to hiking the Miliford Track and jetboating the Dart River.",
  intro:
    "This Australia and New Zealand in 2 weeks holiday offers tours from snorkel Great Barrier Reef to hiking the Miliford Track and jetboating the Dart River.",
  highlights: [
  ...
  days: [
    {
      ...
      title: "Sydney",
      location: "Sydney",
      description: "Sydney is one of the most sought after destinations in Australia - the harbour views of this city are some of the best in the world - the dining is world class. However, Sydney is also famous for golden beaches and a very energetic nightlife.",
      accommodation: {
      ...
      activities: [
        {
          ...
          type: "Included",
          description: "Sailaway Outer Reef Tour — see operator site for full details.",
          affiliateLink: "https://geni.us/FamilyRaftingQT",
        },
        {
          name: "Great Barrier Reef",
          type: "Information",
          description: "Great Barrier Reef — see operator site for full details.",
    ...
    },
    {
      ...
      activities: [
        {
          name: "Daintree Cape Tribulation",
          type: "Included",
          description: "Daintree Cape Tribulation — see operator site for full details.",
        }
      ],
    },
    {
    ...
    },
    {
      ...
      title: "Queenstown",
      location: "Queenstown",
      description: "Explore the Queenstown region today. Depending on the weather, you could also take a scenic flight to Milford Sound which includes a cruise in the fjord.",
      accommodation: {
        name: "Queenstown Park Boutique Hotel",
        description: "Comfortable, well-located stay in Queenstown.",
        affiliateLink: "https://geni.us/QueenstownParkHotel",
      },
      activities: [
        {
        ...
        {
          name: "Queenstown Wine Trail Tours",
          type: "Optional",
          description: "Queenstown Wine Trail Tours — see operator site for full details.",
        ...
        },
        {
          ...
          affiliateLink: "https://geni.us/ZiplineQueenstown",
        },
        {
        ...
        {
          name: "Routeburn Track Guided W",
          type: "Optional",
          description: "Routeburn Track Guided W — see operator site for full details.",
          affiliateLink: "https://geni.us/RouteburnKeyWalk",
        }
      ],
    },
    {

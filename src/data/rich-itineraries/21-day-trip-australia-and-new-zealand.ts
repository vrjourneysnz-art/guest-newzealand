...
export const itin21DayTripAustraliaAndNewZealand: RichItinerary = {
  ...
  metaDescription:
    "This 21 day trip Australia and New Zealand with activities from snorkelling the Great Barrier Reef to hiking the Milford Track.",
  intro:
    "This 21 day trip Australia and New Zealand with activities from snorkelling the Great Barrier Reef to hiking the Milford Track.",
  highlights: [
  ...
  days: [
    {
      ...
      title: "Sydney",
      location: "Sydney",
      description: "Go through the arrival gates at Sydney Airport to meet your driver. You're about to explore one of the most beautiful cities in the world - stunning harbour views, golden beaches, exciting shopping, dining options galore and a vibrant nightlife.",
      accommodation: {
        name: "The Grace Sydney",
        description: "Comfortable, well-located stay in Sydney.",
        affiliateLink: "https://geni.us/VicarageGeraldine",
      },
      activities: [
        {
          name: "Sydney Opera House",
          type: "Optional",
          description: "Sydney Opera House — see operator site for full details.",
        },
        {
          name: "Manly Beach",
          type: "Optional",
          description: "Manly Beach — see operator site for full details.",
        },
        {
          name: "The Rocks",
          type: "Optional",
          description: "The Rocks — see operator site for full details.",
        }
      ],
    },
    {
      ...
      activities: [
        {
          ...
          type: "Included",
          description: "The Essentials Sydney Tour — see operator site for full details.",
        },
        {
          name: "Bridgeclimb Sydney",
          type: "Optional",
          description: "Bridgeclimb Sydney — see operator site for full details.",
        }
      ],
    },
    {
    ...
    },
    {
      ...
      accommodation: {
        name: "Port Dougla",
        description: "Comfortable, well-located stay in Port Douglas.",
      },
      activities: [
    ...
    },
    {
      ...
      accommodation: {
        ...
        description: "Comfortable, well-located stay in Yulara.",
      },
      activities: [
        {
          name: "Soun",
          type: "Optional",
          description: "Soun — see operator site for full details.",
        }
      ],
    },
    {
      ...
      title: "Yulara",
      location: "Yulara",
      description: "Tonight, guests can either join an outback tour or attend the Sound of Silence dinner.",
      accommodation: {
        name: "Sails in the Desert",
        description: "Comfortable, well-located stay in Yulara.",
      },
      activities: [
        {
          ...
          type: "Included",
          description: "Uluru-Kata Tjuta National Park — see operator site for full details.",
        },
        {
          name: "Emu Run Experience 1 Day Uluru Tour from Ayers Rock Resort",
          type: "Included",
          description: "Emu Run Experience 1 Day Uluru Tour from Ayers Rock Resort — see operator site for full details.",
        },
        {
          name: "Outback Camel Tours",
          type: "Optional",
          description: "Outback Camel Tours — see operator site for full details.",
          affiliateLink: "https://geni.us/RuakuriCaveTour",
        },
        {
          name: "Uluru-Kata Tjuta Cultural Centre",
          type: "Optional",
          description: "Uluru-Kata Tjuta Cultural Centre — see operator site for full details.",
        },
        {
          name: "Sounds of Silence",
          type: "Optional",
          description: "Sounds of Silence — see operator site for full details.",
        }
      ],
    },
    {
      ...
      accommodation: {
        name: "The Playford",
        description: "Comfortable, well-located stay in Adelaide.",
        affiliateLink: "https://geni.us/FactoryKaikoura",
      },
      activities: [
        {
          name: "Adelaide Central Market",
          type: "Optional",
          description: "Adelaide Central Market — see operator site for full details.",
        },
        {
          name: "Adelaide Cent",
          type: "Optional",
          description: "Adelaide Cent — see operator site for full details.",
        }
      ],
    },
    {
      ...
      activities: [
        {
          ...
          type: "Included",
          description: "Milford Coach Cruise & Walk — see operator site for full details.",
          affiliateLink: "https://geni.us/TripsTrampsMilfordWalk",
        },
        {
          name: "Real Journeys Milford Sound Scenic Cruise",
          type: "Included",
          description: "Real Journeys Milford Sound Scenic Cruise — see operator site for full details.",
          affiliateLink: "https://geni.us/TripsTrampsMilfordWalk",
        }
      ],
    },
    ...
    },
    {
      ...
      title: "Wanaka",
      location: "Wanaka",
      description: "Wanaka is located on the shore of sparkling Lake Wanaka. Adventure and lifestyle tour options are endless. From sky diving, jet boating, horse trekking to wine tasting and fine food. The Wanaka River Journey tour is the ideal combo and includes a guided walk through an ancient forest and a jet-boat ride down the Matukituki River. There are of hiking trails and walks in the area as well!",
      accommodation: {
        name: "WÄnaka Haven",
      ...
      activities: [
        ...
        {
          name: "Eco Wanaka Rob Roy G",
          type: "Optional",
          description: "Eco Wanaka Rob Roy G — see operator site for full details.",

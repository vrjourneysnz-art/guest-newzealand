...
export const australiaNewZealand16Days: RichItinerary = {
  ...
  metaDescription:
    "This Australia and New Zealand in 16 Days trip offers activities from snorkelGreat Barrier Reef to hiking the Miliford Track.",
  intro:
    "This Australia and New Zealand in 16 Days trip offers activities from snorkelGreat Barrier Reef to hiking the Miliford Track.",
  highlights: [
  ...
  days: [
    {
      ...
      title: "Sydney",
      location: "Sydney",
      description: "Meet your driver at the arrival gate at Sydney Airport to meet your driver. Get ready to explore one of the most beautiful cities in the world - there's so much to enjoy - stunning harbour views, golden beaches, the endless dining options and a vibrant nightlife.",
      accommodation: {
      ...
      activities: [
        {
          ...
          type: "Optional",
          description: "SEA LIFE Sydney Aquarium — see operator site for full details.",
        },
        {
          name: "Manly Beach",
          type: "Optional",
    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          name: "Bondi Beach",
          type: "Information",
          description: "Bondi Beach — see operator site for full details.",
        },
        {
    ...
    },
    {
      ...
      accommodation: {
        name: "Port Douglas Peninsula Boutique Hotel Included ",
      ...
      activities: [
        {
          ...
          type: "Optional",
          description: "Adelaide Planetarium — see operator site for full details.",
        },
        {
          name: "Adelaide Centra",
          type: "Optional",
          description: "Adelaide Centra — see operator site for full details.",
        }
      ],
    },
    {
    ...
    },
    {
      ...
      title: "Auckland",
      location: "Auckland",
      description: "Today, you're going to fly across to beautiful New Zealand! Transfer back to Adelaide Airport and flight from Adelaide to Auckland, New Zealand largest city. Transfer from the airport to your Auckland city hotel.",
      accommodation: {
        name: "Grand Millennium Auckland",
        description: "Comfortable, well-located stay in Auckland.",
        affiliateLink: "https://geni.us/AdinaAuckland",
      },
      activities: [
        {
          name: "Auckland",
          type: "Information",
          description: "Auckland — see operator site for full details.",
          affiliateLink: "https://geni.us/AucklandHopOnCoach",
        }
      ],
    },
    {
    ...
    },
    {
      ...
      title: "Rotorua",
      location: "Rotorua",
      description: "Rotorua and the Lake Taupo region is famous for geothermal activity. Located within the Pacific Rim of Fire, these areas of bubbling mud pools, clouds of steam, and natural hot springs, are a nature's wonderland. There are key thermal sites you should visit today.",
      accommodation: {
      ...
      activities: [
        ...
        {
          name: "Wairakei Terraces & Thermal Health Spa",
          type: "Optional",
          description: "Wairakei Terraces & Thermal Health Spa — see operator site for full details.",
          affiliateLink: "https://geni.us/WaiArikiSpa",
        },
        {
          name: "Hukafalls Jet Re",
          type: "Optional",
          description: "Hukafalls Jet Re — see operator site for full details.",

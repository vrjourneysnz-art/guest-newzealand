  ...
  return (
    <span
      className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
        styles[type] || styles.Information
      }`}
    >
      {type}
    </span>
  ...
  return (
    <div className="border border-gray-100 rounded-lg overflow-hidden bg-white shadow-sm">
      ...
      >
        ...
        <i
          className={`fa-solid fa-chevron-down text-dark/30 transition-transform ${
            expanded ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      {expanded && (
        <div className="px-6 pb-6 border-t border-gray-50">
          <p className="text-dark/60 mt-4 leading-relaxed text-sm whitespace-pre-line">
            {day.description}
          </p>
              ...
              <div className="flex items-center justify-between gap-2 mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-dark text-sm">
                    Check in to {day.accommodation.name}
                  </span>
                </div>
            ...
            <div className="mt-4 space-y-3">
              {day.activities.map((activity, i) => (
                <div key={i} className="border border-gray-100 rounded-lg p-4">
                  ...
                  <p className="text-dark/50 text-xs leading-relaxed mt-1 pl-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-sage-light rounded-lg p-8">
            <h2 className="text-2xl font-bold text-dark mb-3 text-center">
              Plan Your {tripNoun} Trip
            </h2>
            <p className="text-dark/50 text-center mb-6">
              Every part of this itinerary can be amended to your personal requirements. We can add,
              delete or amend — just contact us!
            </p>
          ...
          {/* Useful Travel Resources — affiliate footer */}
          <div className="mt-12 border border-gray-100 rounded-lg p-8">
            ...
            <p className="text-dark/50 text-sm mb-6">
              Planning your own arrangements? These trusted partners offer competitive rates across
              New Zealand.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <span className="font-semibold text-dark text-sm group-hover:text-sage transition-colors">
              ...
              <a
                href="https://geni.us/QTAucklandHotel"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 border border-gray-100 rounded-lg p-4 hover:border-sage/30 hover:bg-sage-light/50 transition-colors group"
              >
